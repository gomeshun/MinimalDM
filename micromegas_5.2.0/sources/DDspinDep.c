...
void SxxF19SHELL(double q,double*S00,double*S01,double*S11) 
{
  ...
  {  double Sp,Sn;
     ...
     {
       Sp=dataPp[0], Sn=dataNp[0];
       for(int i=1;i<dim;i++) { Sp+=un*dataPp[i];Sn+=un*dataNp[i]; un*=u;}
     } 
...
void SxxXe129SHELL(double q,double*S00,double*S01,double*S11)
{
...
void SxxXe131SHELL(double q,double*S00,double*S01,double*S11) // Menendez et al.;  1208.1094
{
