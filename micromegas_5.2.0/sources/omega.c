...
double vs1120F(double T){double r= polint3(T,Ntab,Ttab,  vs1120T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2200F(double T){double r= polint3(T,Ntab,Ttab,  vs2200T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1100F(double T){double r= polint3(T,Ntab,Ttab,  vs1100T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1210F(double T){double r= polint3(T,Ntab,Ttab,  vs1210T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1122F(double T){double r= polint3(T,Ntab,Ttab,  vs1122T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2211F(double T){double r= polint3(T,Ntab,Ttab,  vs2211T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}

double vs1110F(double T){double r= polint3(T,Ntab,Ttab,  vs1110T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2220F(double T){double r= polint3(T,Ntab,Ttab,  vs2220T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1112F(double T){double r= polint3(T,Ntab,Ttab,  vs1112T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1222F(double T){double r= polint3(T,Ntab,Ttab,  vs1222T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1220F(double T){double r= polint3(T,Ntab,Ttab,  vs1220T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2210F(double T){double r= polint3(T,Ntab,Ttab,  vs2210T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2221F(double T){double r= polint3(T,Ntab,Ttab,  vs2221T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1211F(double T){double r= polint3(T,Ntab,Ttab,  vs1211T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}

//double TCoeffF(double T) { return polint3(T,Ntab,Ttab, TCoeff);}

double dY1F(double T){ return polint1(T,Ntab,Ttab, Y1T) ;}
double dY2F(double T){ return polint1(T,Ntab,Ttab, Y2T) ;}
...
double darkOmegaTR(double TR, int Fast, double Beps,int *err)
{
  double Yt;
  int i;
  if(err) *err=0;
...
//printf("T=%E ok\n",T);        
  ...
  if(ExcludedFor2DM)
  {
    ...
    if(strstr(ExcludedFor2DM,"1222")||strstr(ExcludedFor2DM,"2212")) {for(i=0;i<N;i++) {vs1222T[i]=0;vs2221T[i]=0;}  printf("vs1222&vs1221 ignored\n");}
  }
...
double darkOmega2TR( double TR, double fast, double Beps0)
{
  Fast_=fast;
  Beps=Beps0;
  int info=0;
