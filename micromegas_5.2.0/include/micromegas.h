...
extern double darkOmegaTR(double TR, int Fast, double Beps,int *err);
extern double darkOmega2TR(double TR, double fast, double Beps);
...
extern double Xe1TpEff(double E);
...
extern SxxType SxxF19EFT,SxxXe131EFT,SxxXe129EFT, SxxXe129SHELL, SxxXe131SHELL, SxxF19SHELL;

extern int spinDepFlag;   // default value SHELL=0 
